    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "thumbnail",
                    models.ImageField(upload_to="thumbnails", verbose_name="Thumbnail"),
                ),
                ("slug", models.SlugField(unique=True)),
                (
                    "published_at",
                    models.DateTimeField(
                        editable=False, null=True, verbose_name="Publicado em"
                    ),
                ),
                (
                    "is_published",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("UPLOADED_STARTED", "Upload Iniciado"),
                            ("PROCESSING_STARTED", "Processamento Iniciado"),
                            ("PROCESSING_FINISHED", "Processamento Finalizado"),
                            ("PROCESSING_ERROR", "Erro no Processamento"),
                        ],
                        default="UPLOADED_STARTED",
                        max_length=20,
                        verbose_name="Status",
                    ),
                ),
